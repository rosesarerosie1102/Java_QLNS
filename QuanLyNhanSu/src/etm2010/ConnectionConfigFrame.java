...
public class ConnectionConfigFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnlConfig.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Connection Configuration", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Calibri", 1, 14))); // NOI18N
        ...
        btnTestConnection.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/connection-established.png"))); // NOI18N
            ...
            .addGroup(pnlConfigLayout.createSequentialGroup()
                ...
                .addGroup(pnlConfigLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, pnlConfigLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(pnlConfigLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(tfServer, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 225, Short.MAX_VALUE)
                            .addComponent(tfUser, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 225, Short.MAX_VALUE)
                ...
                .addGroup(pnlConfigLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlConfigLayout.createSequentialGroup()
                        ...
                        .addComponent(tfPort, javax.swing.GroupLayout.PREFERRED_SIZE, 69, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(btnClear))
                .addGap(12, 12, 12))
        );

        pnlConfigLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btnClear, btnSave, btnTestConnection});
        ...
        lblWarning.setText("<html>Please enter your appropiate configuration and click Save.You can also test new connection by click Test Connection button.<html>");
        ...
        pnlTopLayout.setVerticalGroup(
            ...
            .addGroup(pnlTopLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblWarning, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private Connection getConnection()
    {
        ...
        try
        {
            ...
            connStr.append(";databaseName=EmployeeTransferManagement2010;user=");
            connStr.append(tfUser.getText().trim());
            connStr.append(";password="+String.valueOf(tfPassword.getPassword(), 0, tfPassword.getPassword().length).trim());
        ...
        catch (SQLException ex)
        {
             JOptionPane.showMessageDialog(null,
                    "Cannot connect to database. Please check your configuration that you have input.",
                    "Connect Fail",
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if(oConn!=null)
        {
            ...
            try
            {
                ...
                data.append(tfServer.getText());data.append("\n");
                data.append(tfPort.getText());data.append("\n");
                data.append(tfUser.getText());data.append("\n");
                data.append(pass);
                ...
                JOptionPane.showMessageDialog(null,
                    "Cannot write data to \"connection.data\" file. Please try later.",
                    "File write failed",
                    JOptionPane.ERROR_MESSAGE
                    );
            }
